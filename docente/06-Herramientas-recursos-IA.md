...
| **GitHub / GitHub Classroom** | Plataforma de alojamiento de repositorios y canal oficial de entrega de laboratorios y proyecto final; permite distribución de plantillas de laboratorio y seguimiento del trabajo de cada estudiante/equipo. |
